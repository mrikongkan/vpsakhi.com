    ...
    <div class="container mt-5">
        <div class="row text-center py-3">
            ...
            if (isset($_SESSION['addusr_id']) && isset($_SESSION['addusr_name'])) {
                echo strtoupper('<small> WELCOME TO YOUR <strong>SELLER</strong> DASHBOARD, ' . strtoupper($_SESSION['addusr_name']) .  "</small>");
                 $usr_creator = $_SESSION['addusr_id'];
            } else {
        ...
        <div class="row text-left py-3 form-validate">
            ...
            <form class="row g-2" method="post" action="addnew_user.php" enctype="multipart/form-data" onsubmit="return dataValidatelogIn();">
                ...
                <!--</div>-->
                <div class="col-md-1">
                    <button type="submit" onclick="return chcekcreate();" style="margin-top: 35px;" name="addnew_user" class="btn app-btn-primary w-100 theme-btn mx-auto">Create</button>
                </div>
                            ...
                            <div class="app-card app-card-orders-table shadow-sm mb-5">
                                <div class="app-card-body">
                                    <div class="table-responsive">  
                                        <?php 
                                            $st = "SELECT * FROM `u241746118_ems`.`adduser` WHERE `usraccnt_by`= '$usr_creator'";
                                       ...
                                       <table class="table app-table-hover mb-0 text-center <?php echo $displaytable;?>">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <?php
                                                    $i = 1;
                                                    $stmnt = "SELECT * FROM `u241746118_ems`.`adduser` WHERE `usraccnt_by`= '$usr_creator' ";
                                                    ...
                                                    <script type="text/javascript">
                                                        ...
                                                        if(status == "Active"){
                                                            ...
                                                            <td class="cell"><a class="btn-sm app-btn-secondary" id="deactivationbtn" href="deactivae_user.php?id=<?php echo $row['seller_id'];?>">Deactivate</a></td>
...
<script type="text/javascript">
    ...
    function chcekcreate(){
            return confirm('Are You Want To Create an Seller ID?');
        }
</script>
