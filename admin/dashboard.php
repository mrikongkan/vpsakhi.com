    ...
    <div class="container mt-5">
        <div class="row text-center py-3">
            ...
            if (isset($_SESSION['usr_id']) && isset($_SESSION['usr_name'])) {
                echo strtoupper('<small> WELCOME TO YOUR <strong>Admin</strong> DASHBOARD, ' . strtoupper($_SESSION['usr_name']) . "</small>");
                 $admin_srecrt = $_SESSION['usr_id'];
            } else {
            ...
            <form class="row g-2" method="post" action="addnew_user.php" enctype="multipart/form-data" onsubmit="return dataValidatelogIn();">
                ...
                <div class="col-md-2">
                    ...
                    <select id="UserRoleFor" name="UserRoleFor" class="form-select">
                        ...
                        <option name="UserRoleFor">Super</option>
                            ...
                            <div class="app-card app-card-orders-table shadow-sm mb-5">
                                <div class="app-card-body">
                                    <div class="table-responsive">  
                                        <?php 
                                            $st = "SELECT * FROM `u241746118_ems`.`adduser`  WHERE `usraccnt_by` = '$admin_srecrt'";
                                       ...
                                       <table class="table app-table-hover mb-0 text-center <?php echo $displaytable;?>">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <?php
                                                    $i = 1;
                                                    $stmnt = "SELECT * FROM `u241746118_ems`.`adduser` WHERE `usraccnt_by` = '$admin_srecrt'";
                                                    ...
                                                    <script type="text/javascript">
                                                        ...
                                                        if(status == "Active"){
                                                            ...
                                                            <td class="cell"><?php echo $row['addusr_role']; ?></td>
